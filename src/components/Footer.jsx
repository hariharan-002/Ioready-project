    ...
    <>
        <div className="footer-container">
            <div className="subscribe-container">
                <div>       <b> <p>Subscribe to our newsletter for regular updates about Offers, Coupons & more</p></b>
                    <p> <input type="email" placeholder='enter your email ' />  <button>subscribe</button></p>
                </div>
                <div>
                    <h4>FOLLOW US</h4>
            ...
            <div className="link-container">
                <div className="div-1">  <p style={{ fontWeight: 'bold' }}>Company</p> <p>About</p> <p>Careers</p> <p>Partnerships</p> <p>Blog</p> <p>How we work</p></div>
